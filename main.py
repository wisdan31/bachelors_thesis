...
def run_visual_demo():
    ...
    padding = 40  # Increased padding for better separation
    total_width = width * 2 + padding
    
    # Information banner heights
    banner_height = 50
    ...
    while running:
        ...
        # Rendering Engine
        # Fill background with dark gray so black fog stands out
        ...
        screen.blit(maze_surface_left, (0, banner_height + panel_title_height))
        # Left Border
        pygame.draw.rect(screen, (100, 100, 100), (0, banner_height + panel_title_height, width, height), 3)
        ...
        screen.blit(maze_surface_right, (width + padding, banner_height + panel_title_height))
        # Right Border
        pygame.draw.rect(screen, (100, 100, 100), (width + padding, banner_height + panel_title_height, width, height), 3)
        
        # --- SEPARATOR ---
        pygame.draw.line(screen, (80, 80, 90), (width + padding // 2, banner_height), (width + padding // 2, total_height), 4)
        ...
        screen.blit(title_left, (width // 2 - title_left.get_width() // 2, banner_height + 8))
        ...
        screen.blit(title_right, (width + padding + width // 2 - title_right.get_width() // 2, banner_height + 8))
